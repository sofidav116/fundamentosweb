...
class AmiiboRepository(
    ...
    /**
     * =========================================================================
     * PARTE 2: BÚSQUEDA LOCAL (FLUJO REACTIVO)
     * =========================================================================
     *
     * Expone el Flow de búsqueda de Room para filtrado local.
     *
     * @param query Texto de búsqueda (busca por nombre)
     * @return Flow que emite automáticamente cuando:
     *         - El query cambia
     *         - Los datos en la tabla cambian
     *
     * VENTAJAS DE USAR ROOM EN LUGAR DE FILTRADO EN MEMORIA:
     * - Aprovecha índices de base de datos (más rápido)
     * - Eficiente para datasets grandes
     * - Búsqueda case-sensitive nativa de SQL
     * - Room maneja automáticamente el threading
     */
