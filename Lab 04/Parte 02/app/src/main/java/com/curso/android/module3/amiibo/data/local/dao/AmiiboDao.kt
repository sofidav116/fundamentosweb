...
interface AmiiboDao {
    ...
    /**
     * =========================================================================
     * PARTE 2: QUERY de búsqueda local
     * =========================================================================
     *
     * Filtra Amiibos por nombre usando búsqueda parcial (LIKE).
     *
     * SQL LIKE: Permite búsqueda de patrones
     * - '%texto%': Encuentra 'texto' en cualquier parte del string
     * - El operador || concatena strings en SQLite
     *
     * Flow reactivo: Se actualiza automáticamente cuando:
     * - El query cambia
     * - Los datos en la tabla cambian
     *
     * EJEMPLO:
     * searchAmiibos("Mario") → Encuentra "Mario", "Super Mario", "Dr. Mario"
     */
