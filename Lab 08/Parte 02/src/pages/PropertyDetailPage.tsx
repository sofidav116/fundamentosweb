    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* ---------------------------------------------------------------
            GALERÍA DE IMÁGENES
            Reemplaza la cuadrícula simple anterior por la galería interactiva.
            Muestra miniaturas clicables que abren el modal a pantalla completa.
          --------------------------------------------------------------- */}
          {property.images.length > 0 && (
            <div>
              <h2 className="text-lg font-semibold mb-3">
                Galería ({property.images.length} {property.images.length === 1 ? 'imagen' : 'imágenes'})
              </h2>
              <ImageGallery
