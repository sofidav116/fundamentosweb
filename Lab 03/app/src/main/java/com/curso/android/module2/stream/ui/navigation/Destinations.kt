...
/**
 * Destino: Pantalla de Destacados (Highlights)
 *
 * Muestra canciones destacadas o recomendadas.
 * No requiere argumentos, por lo que se define como un object.
 *
 * Esta pantalla puede ser accesible desde Home u otras secciones
